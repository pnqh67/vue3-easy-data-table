...
const _withScopeId = (n) => (pushScopeId("data-v-6a9a6a59"), n = n(), popScopeId(), n);
const _hoisted_1 = ["id"];
...
const _sfc_main = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "3b76f80b": tableMinHeightPx.value,
      "770ec7c5": tableHeightPx.value
    }));
    const {
      tableNodeId,
      clickEventType,
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          createElementVNode("table", { id: unref(tableNodeId) }, [
                ...
                return openBlock(), createElementBlock(Fragment, { key: index }, [
                  createElementVNode("tr", {
                    ...
                    onClick: ($event) => {
                      ...
                      _ctx.clickRowToExpand && unref(updateExpandingItemIndexList)(index + prevPageEndIndex.value, item, $event);
                    },
                    onDblclick: ($event) => {
                  ...
                  ifHasExpandSlot.value && unref(expandingItemIndexList).includes(index + prevPageEndIndex.value) ? (openBlock(), createElementBlock("tr", {
                    key: 0,
                    class: normalizeClass([
                      { "even-row": (index + 1) % 2 === 0 },
            ...
            ], 2)) : unref(headersForRender).length && !_ctx.hideHeader ? (openBlock(), createElementBlock("tfoot", {
              key: 4,
              class: normalizeClass(["vue3-easy-data-table__header", [_ctx.headerClassName]])
            }, [
              createElementVNode("tr", null, [
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6a9a6a59"]]);
